;####################################################
;# SWITCH DECODER SBHF LEFT (W1, W2)                #
;####################################################
;# VERSION 3.0.0 - 2015/12/04                       #
;####################################################
;# CHANGE LOG					    #
;#  - 3.0.0 : Adjusted for hardware patch	    #
;#		Switch drive pins use inverse logic #
;####################################################
;# PIN LAYOUT					    #
;#  - C<0:3> boosted O/C output (inverse logic)     #
...
write_output:
    ...
    andwf   state, W
    xorwf   output, W
    btfsc   STATUS, Z ; return if no activation required
    return
    xorlw   0xFF  ; invert output
    iorlw   0xF0
...
resolve:
    ...
    retlw   b'1001' ;J  1010
    retlw   b'0000' ;0  1011
    retlw   b'0010' ;BK 1100
    retlw   b'0010' ;CK	1101
