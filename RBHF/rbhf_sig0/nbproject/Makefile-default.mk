...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/rbhf_sig0.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=rbhf_sig0.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/rbhf_sig0.o
POSSIBLE_DEPFILES=${OBJECTDIR}/rbhf_sig0.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/rbhf_sig0.o

# Source Files
SOURCEFILES=rbhf_sig0.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/rbhf_sig0.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/rbhf_sig0.o: rbhf_sig0.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/rbhf_sig0.o: rbhf_sig0.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/rbhf_sig0.o.d 
	@${RM} ${OBJECTDIR}/rbhf_sig0.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/rbhf_sig0.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION) -u  -l\\\"${OBJECTDIR}/rbhf_sig0.lst\\\" -e\\\"${OBJECTDIR}/rbhf_sig0.err\\\" $(ASM_OPTIONS)   -o\\\"${OBJECTDIR}/rbhf_sig0.o\\\" \\\"rbhf_sig0.asm\\\" 
	@${DEP_GEN} -d "${OBJECTDIR}/rbhf_sig0.o"
	@${FIXDEPS} "${OBJECTDIR}/rbhf_sig0.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
dist/${CND_CONF}/${IMAGE_TYPE}/rbhf_sig0.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../moba_libraries.X/dist/default/production/moba_libraries.X.lib 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -odist/${CND_CONF}/${IMAGE_TYPE}/rbhf_sig0.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   ../../moba_libraries.X/dist/default/production/moba_libraries.X.lib  
endif
